...
local probability1 = get_probability_value_for_inserting(g_pixel_scene_04, probability_to_replace_pixelscene)
local probability2 = get_probability_value_for_inserting(g_pixel_scene_04_alt, probability_to_replace_pixelscene)

table.insert(g_pixel_scene_04, {
  prob   		    	= probability1,
  material_file 	= "mods/noita.thingsmod/content/altar_of_renewing/files/loader_scenes/excavationsite.png",
  visual_file		  = "",
  background_file	= "",
  is_unique		    = 0
})
