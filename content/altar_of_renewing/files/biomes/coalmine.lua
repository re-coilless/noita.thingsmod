...
local probability_to_replace_pixelscene = occurence_rate_to_probability(wang_tile_short_side, wang_tile_count_h, wang_tile_count_v,
  custom_pixel_scene_count_h, custom_pixel_scene_count_v, 0.0875)
...
table.insert(g_pixel_scene_02, {
  prob   		    	= probability,
  material_file 	= "mods/noita.thingsmod/content/altar_of_renewing/files/loader_scenes/coalmine.png",
  visual_file		  = "",
  background_file	= "",
  is_unique		    = 0
})
