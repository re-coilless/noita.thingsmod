...
local probability_to_replace_pixelscene = occurence_rate_to_probability(wang_tile_short_side, wang_tile_count_h, wang_tile_count_v,
  custom_pixel_scene_count_h, custom_pixel_scene_count_v, 0.05)
...
table.insert(g_pixel_scene_01, {
  prob   		    	= probability1,
  material_file 	= "mods/noita.thingsmod/content/altar_of_renewing/files/loader_scenes/rainforest_v.png",
  visual_file		  = "",
  background_file	= "",
  is_unique		    = 0
})
...
table.insert(g_pixel_scene_02, {
  prob   		    	= probability2,
  material_file 	= "mods/noita.thingsmod/content/altar_of_renewing/files/loader_scenes/rainforest_h.png",
  visual_file		  = "",
  background_file	= "",
  is_unique		    = 0
})
