...
local probability = get_probability_value_for_inserting(g_pixel_scene_01, probability_to_replace_pixelscene)
table.insert(g_pixel_scene_01, {
  prob   		    	= probability,
  material_file 	= "mods/noita.thingsmod/content/altar_of_renewing/files/loader_scenes/volcanobiome.png",
  visual_file	  	= "",
  background_file	= "",
  is_unique		    = 0
})
