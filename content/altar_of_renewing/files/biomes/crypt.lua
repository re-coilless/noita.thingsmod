...
local probability = get_probability_value_for_inserting(g_pixel_scene_03, probability_to_replace_pixelscene)
local material_file = ANVIL_OF_DESTINY_MATERIAL_FILE or "mods/noita.thingsmod/content/altar_of_renewing/files/loader_scenes/crypt.png"
