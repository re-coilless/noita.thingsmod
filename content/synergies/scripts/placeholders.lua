...
C.gfx_replacement = [[
	<Sprite 
	filename="replace_this" 
	hotspots_filename="data/enemies_gfx/player_hotspots.png" 
	offset_x="6" 
	offset_y="14" 
...
<Sprite
  filename="replace_this"
  hotspots_filename="data/enemies_gfx/player_arm_hotspots.png"
  offset_x="0"
  offset_y="2" 
